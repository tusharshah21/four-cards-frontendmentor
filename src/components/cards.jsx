...
function cards() {
  return (
    <div>
      <div className="poppins-regular text-[hsl(234,12%,34%)]">
        <h2 className="text-2xl lg:text-4xl poppins-extralight">
          Reliable, efficient delivery
        </h2>
        <h1 className="poppins-semibold text-2xl lg:text-4xl my-2">
          Powered by Technology
        </h1>
        <h2 className="poppins-regular text-sm lg:text-md text-[hsl(229,6%,66%)] mt-2">
          Our Artificial Intelligence powered tools use millions of project data
          <br />
          points to ensure that your project is successful
        </h2>
      </div>
      <div className="text-left text-[hsl(234,12%,34%)] mt-12">
        <div class="grid grid-col-1 lg:grid-cols-3 gap-8 ">
          <div class="my-auto p-8 shadow-2xl rounded-xl border-t-4 border-[hsl(180,62%,55%)]">
            <h1 className="text-2xl poppins-semibold my-2">Supervisor</h1>
            <p className="text-[hsl(229,6%,66%)] lg:pr-4">
          ...
          <div>
            <div class="p-8 shadow-2xl rounded-xl border-t-4 border-[hsl(0,78%,62%)]">
              <h1 className="text-2xl poppins-semibold my-2">Team Builder</h1>
              <p className="text-[hsl(229,6%,66%)] lg:pr-4">
            ...
            <div class="mt-8 p-8 col-start-2 shadow-2xl rounded-xl border-t-4 border-[hsl(34,97%,64%)]">
              <h1 className="text-2xl poppins-semibold my-2">Karma</h1>
              <p className="text-[hsl(229,6%,66%)] lg:pr-4">
          ...
          <div class="my-auto p-8 shadow-2xl rounded-xl border-t-4 border-[hsl(212,86%,64%)]">
            <h1 className="text-2xl poppins-semibold my-2">Calculator</h1>
            <p className="text-[hsl(229,6%,66%)] lg:pr-4">
              {" "}
